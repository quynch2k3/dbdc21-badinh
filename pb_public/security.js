...
(function () {
    ...
    // 0. Whitelist Bots (Facebook, Google, etc.)
    const isBot = /facebookexternalhit|Facebot|Googlebot|Twitterbot|Bingbot/i.test(navigator.userAgent);
    if (isBot) {
        console.log("BOT ACCESS DETECTED - SECURITY BYPASSED");
        return; 
    }
